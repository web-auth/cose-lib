...
/**
 * ECDH-SS + A192KW (RFC 9053, section 6.4.1, table 16): Static-Static ECDH, the shared secret run through HKDF SHA-256 into a 192-bit AES Key Wrap key.
 */
final class ECDH_SS_A192KW extends Ecdh
{
    public const ID = -33;
