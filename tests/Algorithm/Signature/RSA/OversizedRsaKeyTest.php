...
final class OversizedRsaKeyTest extends TestCase
{
    ...
    public static function getOversizedKeys(): iterable
    {
        ...
        // One bit too many. Odd, so that it is the length and not the parity of RFC 8017, section 3.1 that rejects it.
        $oversizedModulus = "\x01" . str_repeat("\xaa", self::MAXIMUM_MODULUS_OCTETS - 1) . "\xff";
    ...
    public function aSignatureStillRoundTripsWithoutABigIntegerExtension(RsaKey $key): void
    {
        // Given
    ...
    {
        yield 'a 2048 bit modulus' => [RsaKeys::privateKey()];
        yield 'a 2050 bit modulus' => [RsaKeys::nonByteAlignedPrivateKey()];
    }
