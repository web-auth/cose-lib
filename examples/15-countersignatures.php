...
example_diagnostic('Countersign_structure', (string) $toBeSigned);
...
example_diagnostic('countersigned', $encoded);
echo PHP_EOL;
...
example_diagnostic('countersigned twice', $decoded);
$target = CountersignTarget::of($decoded);
...
example_diagnostic('countersigned COSE_Mac0', $mac0);
