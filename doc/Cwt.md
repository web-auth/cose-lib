...
integer is a CoAP Content-Format identifier (0 to 65535, [RFC 7252 §12.3](https://www.rfc-editor.org/rfc/rfc7252#section-12.3));
...
> structure MUST verify that their values are identical". The library cannot do this for you, the payload being opaque
