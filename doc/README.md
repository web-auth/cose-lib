...
| [RFC 3161 Timestamp Tokens](Timestamps.md) | RFC 9921: `3161-ttc` and `3161-ctt`, `MessageImprint` for each mode and structure, `TimeStampToken`, `TimestampBinding`, and where the library stops |
...
| `tests/Structure/Timestamp/Rfc9921ExamplesTest.php` | The imprints of RFC 9921 §3.1.1 and §3.1.2 over the RFC 9052 messages, the Appendix A.1 token bound to its payload, and why the Appendix A.2 token does not bind |
...
- [RFC 9921 - CBOR Object Signing and Encryption (COSE) Header Parameter for Timestamp Tokens as Defined in RFC 3161](https://www.rfc-editor.org/rfc/rfc9921.html)
